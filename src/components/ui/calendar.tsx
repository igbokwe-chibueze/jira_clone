  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        [UI.CaptionLabel]: "sr-only", // hide default label when using dropdown
        ...
        [UI.Dropdowns]: "flex flex-col space-y-2 md:flex-row md:space-y-0 md:space-x-2 justify-center",
        [UI.DropdownRoot]: "flex-1 relative",     
        // [UI.Dropdown]: "flex-1 inline-flex relative focus-within:z-20",
        [UI.Dropdown]: cn(
          buttonVariants({ variant: "outline" }),
        ...
        // Preserve any extra overrides passed in
        ...classNames,
      }}
      components={{
        // Use the same chevron for dropdown arrow
